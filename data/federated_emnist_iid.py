...
class FederatedEMNISTDatasetIID:
    ...
    def _init_data(self, data_dir):
        ...
        if os.path.isfile(file_name):
            ...
            dataset = self.preprocess(data_dir, self.min_num_samples)
            # with open(file_name, 'wb') as f:
            #     pickle.dump(dataset, f)
        self.dataset = dataset


    def preprocess(self,data_dir, min_num_samples):
        ...
        num_clients_train=self.train_num_clients
        num_clients_test=self.test_num_clients
