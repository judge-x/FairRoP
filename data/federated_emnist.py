...
def preprocess(data_dir, num_clients=None):
    # data_dir_linux=os.path.join(data_dir, r'fed_emnist_train.h5')
    # print(data_dir_linux)
    path_train= './dataset/FederatedEMNIST/fed_emnist_train.h5'
    path_test= './dataset/FederatedEMNIST/fed_emnist_test.h5'
    # data_dir_win='H:\\fed-inside\\FL\\fair-exp\\Active-Client-Selection-for-Communication-efficient-Federated-Learning-main\\src\\data\\dataset\\FederatedEMNIST\\fed_emnist_train.h5'
    # data_dir_win_test='H:\\fed-inside\\FL\\fair-exp\\Active-Client-Selection-for-Communication-efficient-Federated-Learning-main\\src\\data\\dataset\\FederatedEMNIST\\fed_emnist_test.h5'
    train_data = h5py.File(path_train, 'r')
    test_data = h5py.File(path_test, 'r')
    ...
    with open(os.path.join(data_dir, 'FederatedEMNIST\\FederatedEMNIST_preprocessed.pickle').replace('\\','/'), 'wb') as f:
