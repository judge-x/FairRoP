...
class FederatedEMNISTDataset_nonIID:
    ...
    def _init_data(self, data_dir):
        ...
        if os.path.isfile(file_name):
            ...
            train_data_local_dict, train_data_local_num_dict = self.partition_EMNIST_dataset(data_dir, matrix, train=True)
            test_data_local_dict, test_data_local_num_dict = self.partition_EMNIST_dataset(data_dir, matrix, train=False)
    ...
    def partition_EMNIST_dataset(self, data_dir, matrix, train):
        ...
        if self.balanced:
            ...
            n_samples = [80] * int(0.1 * n_clients) + [200] * int(0.3 * n_clients) + [400] * int(0.3 * n_clients) + [
                600] * int(0.2 * n_clients) + [800] * int(0.1 * n_clients)
