...
class Client(object):
    ...
    def train(self, global_model):
        ...
        if self.num_epoch == 0:  # no SGD updates
            result,flattened_diff_model = self.trainer.train_E0(self.labeled_data)
        else:
            result,flattened_diff_model = self.trainer.train(self.labeled_data)
        ...
        return result,flattened_diff_model
